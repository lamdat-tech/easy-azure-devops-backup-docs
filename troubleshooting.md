...
**Backup:** Code (Read), Build (Read), Work Items (Read), Variable Groups (Read), Project and Team (Read)
**Restore:** Code (Read & Write), Build (Read & Write), Work Items (Read & Write), Variable Groups (Read & Write), Project and Team (Read & Write)
